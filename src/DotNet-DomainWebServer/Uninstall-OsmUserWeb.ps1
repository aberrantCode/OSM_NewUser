...
.PARAMETER Force
    Skip the interactive confirmation prompt.  Used by Uninstall-OsmUserWeb-Remote.ps1
    when running in a non-interactive PS Remoting session.
